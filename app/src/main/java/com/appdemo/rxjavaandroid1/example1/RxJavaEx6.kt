...
class RxJavaEx6(private val schedulerProvider: SchedulerProvider) {
    ...
    fun callRxFunctionality() {
        ...
        compositeDisposable.add(
            observable.subscribeOn(schedulerProvider.io()).observeOn(schedulerProvider.ui()).subscribeWith(getObserver())
        )
    }
